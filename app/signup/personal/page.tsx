...
//
// Personal signup form. Mirrors the firm form but with personal-account
// copy and a single "Your name" field (no firm name — under the hood we
// create a firm-of-one for them, but the user shouldn't see firm
// terminology anywhere). Submits to /api/signup/personal.
