...
"NETFLIX", "SPOTIFY", "ADOBE", "DROPBOX", "ZOOM", "SLACK",
  "EBGAMES", "EB GAMES", "GAMESTOP", "INDIGO", "CHAPTERS",
  "SPORT CHEK", "ATMOSPHERE", "MARKS", "WINNERS", "HOMESENSE",
  "TJX", "OLD NAVY", "GAP", "BANANA REPUBLIC", "H&M", "ZARA",
  "UNIQLO", "LULULEMON", "ROOTS", "ALDO", "SPORT MART",
  "CINEPLEX", "CINEMAS", "THEATRE", "GoodLife", "GOODLIFE",
  "CURVES", "ANYTIME FITNESS", "YMCA", "PLANET FITNESS",
  "MCDERMOTT", "CARA", "RECIPE UNLIMITED", "DINE BRANDS",
  "DAIRY QUEEN", "DQ", "TACO BELL", "CHIPOTLE", "FIVE GUYS",
  "MUCHO BURRITO", "FRESHII", "MARY BROWNS", "SWISS CHALET",
  "EAST SIDE MARIOS", "BOSTON PIZZA", "JACK ASTORS", "JOEYS",
  "MILESTONES", "EARLS", "CACTUS CLUB", "MOXIES", "KELSEY",
  "MONTANA", "THE KEG", "LONE STAR", "MCDERMOTT", "HOOTERS",
  "ST LOUIS", "BP", "BIER MARKT", "FIRKIN", "FATHERS AND SONS",
  "ULTRAMAR", "PIONEER", "IRVING", "SUNOCO", "CIRCLE K",
  "COUCHE-TARD", "MAC", "NEEDS CONVENIENCE",
  "REXALL", "JEAN COUTU", "PHARMAPRIX", "GUARDIAN",
  "LONDON DRUGS", "WALMART PHARMACY", "COSTCO PHARMACY",
  "VISIONS ELECTRONICS", "HENRY'S", "VISTEK",
  "CANADA COMPUTERS", "MEMORY EXPRESS", "TIGER DIRECT",
  "IKEA", "STRUCTUBE", "WAYFAIR", "ARTICLE",
  "SIMONS", "REITMANS", "RW&CO", "JOSEPH RIBKOFF",
  "ARDENE", "PENNINGTONS", "ADDITION ELLE",
  "SEPHORA", "MAC COSMETICS", "LUSH", "THE BODY SHOP",
  "HEAL WELLNESS", "HEAL",
];
